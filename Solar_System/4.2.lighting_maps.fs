...
void main()
{
    ...
    vec3 diffuse = light.diffuse * diff * mix(texture(material.diffuse, TexCoords), mix(texture(material.li,TexCoords),texture(material.specular, TexCoords),0.5),0.3).rgb;  
    ...
    vec3 result = ambient*0.1 + diffuse + specular*0.3;
